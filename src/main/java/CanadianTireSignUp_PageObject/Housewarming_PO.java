...
public class Housewarming_PO extends BaseClass {
    public Housewarming_PO(WebDriver driver){super(driver);}
    ...
    public boolean Housewarming_Registry() throws IOException{
        ...
        try {
            ...
            WebElement houseWarmingRegType= driver.findElement(By.xpath(prop.getProperty("houseReg")));
            houseWarmingRegType.click();
            System.out.println("Registry type:\t" +houseWarmingRegType.getText());

            String date= new SimpleDateFormat("dd/MM/yyyy").format(new Date());
            WebElement evntDte= driver.findElement(By.id(prop.getProperty("houseeventDate")));
            evntDte.sendKeys(date);
            System.out.println("Event Date:\t" +date);

            WebElement fname= driver.findElement(By.cssSelector(prop.getProperty("houseFname")));
            fname.sendKeys(prop.getProperty("FirstName"));

            WebElement lname= driver.findElement(By.cssSelector(prop.getProperty("houseLname")));
            ...
            WebElement signUpCompletepage= driver.findElement(By.xpath(prop.getProperty("houseSignupcompletePage")));
            WebElement title= driver.findElement(By.xpath(prop.getProperty("houseSignupcompletePage1")));
