...
public class HolidayRegistry_PO extends BaseClass {
    public HolidayRegistry_PO(WebDriver driver){super(driver);}
    ...
    public boolean Holiday_Registry() throws IOException{
        ...
        try {
            ...
            WebElement holdayRegType= driver.findElement(By.xpath(prop.getProperty("holdayReg")));
            holdayRegType.click();
            System.out.println("Registry type:\t" +holdayRegType.getText());

            String date= new SimpleDateFormat("dd/MM/yyyy").format(new Date());
            WebElement evntDte= driver.findElement(By.id(prop.getProperty("holdayeventDate")));
            evntDte.sendKeys(date);
            System.out.println("Event Date:\t" +date);

            WebElement fname= driver.findElement(By.cssSelector(prop.getProperty("holdayFname")));
            fname.sendKeys(prop.getProperty("FirstName"));

            WebElement lname= driver.findElement(By.cssSelector(prop.getProperty("holdayLname")));
            ...
            WebElement address1= driver.findElement(By.cssSelector(prop.getProperty("holdayAddress1")));
            address1.clear();
            ...
            WebElement phone= driver.findElement(By.cssSelector(prop.getProperty("holdayPhone")));
            phone.clear();
            ...
            WebElement signUpCompletepage= driver.findElement(By.xpath(prop.getProperty("holdaySignupcompletePage")));
            WebElement title= driver.findElement(By.xpath(prop.getProperty("holdaySignupcompletePage1")));
