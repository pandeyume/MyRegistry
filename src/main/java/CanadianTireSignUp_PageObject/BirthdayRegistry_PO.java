...
public class BirthdayRegistry_PO extends BaseClass {
    public BirthdayRegistry_PO(WebDriver driver){super(driver);}
    ...
    public boolean Birthday_Registry() throws IOException{
        ...
        try{
            ...
            WebElement bdayRegType= driver.findElement(By.xpath(prop.getProperty("bdayReg")));
            bdayRegType.click();
            System.out.println("Registry type:\t" +bdayRegType.getText());

            String date= new SimpleDateFormat("dd/MM/yyyy").format(new Date());
            WebElement evntDte= driver.findElement(By.id(prop.getProperty("bdayeventDate")));
            evntDte.sendKeys(date);
            System.out.println("Event Date:\t" +date);

            WebElement fname= driver.findElement(By.cssSelector(prop.getProperty("bdayFname")));
            fname.sendKeys(prop.getProperty("FirstName"));

            WebElement lname= driver.findElement(By.cssSelector(prop.getProperty("bdayLname")));
            ...
            WebElement address1= driver.findElement(By.cssSelector(prop.getProperty("bdayAddress1")));
            address1.clear();
            ...
            WebElement phone= driver.findElement(By.cssSelector(prop.getProperty("bdayPhone")));
            phone.clear();
            ...
            WebElement signUpCompletepage= driver.findElement(By.xpath(prop.getProperty("bdaySignupcompletePage")));
            WebElement title= driver.findElement(By.xpath(prop.getProperty("bdaySignupcompletePage1")));
